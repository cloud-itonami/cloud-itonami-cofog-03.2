...
`cloud-itonami-cofog-03.2` is an OSS open-business blueprint. Governance covers both code and
the operator model.
...
- the advisor cannot directly dispatch a robot action or commit a public
  record.
- the Fire-Risk Governor remains independent of the advisor.
...
licensing the operator's jurisdiction requires for fire-risk inspection work.
