...
`cloud-itonami-cofog-03.2` accepts contributions to the OSS actor, governor tests,
...
- Keep production actions behind the Fire-Risk Governor.
- Treat fire-risk inspection as a safety-relevant domain: add tests for permission,
